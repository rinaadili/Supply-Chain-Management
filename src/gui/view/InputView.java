 ...
 * @author EN
 */
public class InputView extends javax.swing.JInternalFrame {

    /**
     * Creates new form Request
     */
    InputsInterface cir = new InputsRespiratory();
    InputsTableModel ctm = new InputsTableModel();
    ...
    public InputView(Permission prem,Objects obj,Title tit,Users u) {
        premission = prem;
        object = obj;
        title = tit;
        users = u;
    ...
    public void loadTable2() {
        try {
            List<Inputs> list = cir.findAll();
            List<Inputs> list1= new ArrayList<>();
        ...
        tabela.addMouseListener(new MouseAdapter() {
         public void mouseClicked(MouseEvent evt) {
             if (evt.getClickCount() == 2) {
                 ...
                 Inputs c = ctm.getInputs(row);
                 int id = c.getInputID();
                 InputDetailsView rdv;
                 try {
                     rdv = new InputDetailsView(id,users);
