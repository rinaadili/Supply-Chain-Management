...
import gui.model.CityTableModel;
...
public class CityForm extends javax.swing.JInternalFrame {
     ...
     */
    CityInterface cir = new CityRepository();
    ...
    private void tabelaSelectedIndexChange() {
        ...
        rowSM.addListSelectionListener(new ListSelectionListener() {
            ...
            public void valueChanged(ListSelectionEvent Ise) {
                ...
                if (selectedIndex > -1) {
                    City c = ctm.getCity(selectedIndex);
                    emriTF.setText(c.getCityName());
                    countryTF.setText(c.getCountryID() + "");
    ...
    private void initComponents() {
        ...
        countryTF.setMinimumSize(new java.awt.Dimension(6, 19));
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addComponent(countryTF, javax.swing.GroupLayout.PREFERRED_SIZE, 170, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void saveBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveBtnActionPerformed
        if (!emriTF.getText().trim().equals("")) {
            ...
            if (row == -1) {
                City c = new City();
                c.setCityName(emriTF.getText());
                c.setCountryID(new Country(Integer.parseInt(countryTF.getText())));
